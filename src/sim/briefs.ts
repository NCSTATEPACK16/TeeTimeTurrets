...
export const COURSE_BRIEFS: readonly HoleBrief[] = [
  {
    ...
    parTarget: 5,
    archetype: "dogleg",
    dogleg: { dir: "left", severity: 0.48 },
    biome: "parkland",
    corridor: COVER_CORRIDOR.open,
    cover: "open",
    hazards: { bunkers: bunkers("landing-zone", "greenside-right"), water: null },
    signature: false,
    note: "Par 5, 508 yards, teed beside the clubhouse and bending gently left along County Home Road. Wide and unpunitive: the opener is where a player learns the swing HUD, not where they are tested.",
  },
  {
    number: 2,
    parTarget: 4,
    archetype: "dogleg",
    dogleg: { dir: "right", severity: 0.24 },
    biome: "parkland",
    corridor: COVER_CORRIDOR.moderate,
    cover: "moderate",
    hazards: { bunkers: bunkers("fairway-elbow", "greenside-left"), water: null },
    signature: false,
    note: "Par 4 turning back north off the road. The elbow bunker prices the inside line; the wide side is always available and always longer.",
  },
  {
    number: 3,
    parTarget: 4,
    ...
    hazards: { bunkers: bunkers("landing-zone", "greenside-right"), water: null },
    signature: false,
    note: "The same yardage as 2 and none of its shape. Dead straight up the eastern boundary, which in cart combat means no cover for 350 m.",
  },
  {
    number: 4,
    parTarget: 3,
    ...
    corridor: COVER_CORRIDOR.open,
    cover: "open",
    hazards: { bunkers: bunkers("greenside-left", "greenside-right"), water: { form: "crossing" } },
    signature: true,
    note: "SIGNATURE. The short hole over the north-east pond, and the one a stranger remembers. 180 yards, all of it carry, the green ringed in sand rather than bail-out.",
  },
  {
    number: 5,
    parTarget: 4,
    archetype: "dogleg",
    dogleg: { dir: "right", severity: 0.4 },
    biome: "parkland",
    corridor: COVER_CORRIDOR.dense,
    cover: "dense",
    hazards: { bunkers: bunkers("greenside-left"), water: null },
    signature: false,
    note: "Back south through the trees. Narrow enough to be a knife fight, short enough that the driver is a question rather than an answer.",
  },
  {
    number: 6,
    parTarget: 3,
    ...
    corridor: COVER_CORRIDOR.open,
    cover: "open",
    hazards: { bunkers: bunkers("greenside-left", "greenside-left", "greenside-right"), water: null },
    signature: false,
    note: "The short connector west across the top of the block, exposed where parkland gives way to links. Wind and a small target ringed by pot bunkers.",
  },
  {
    number: 7,
    parTarget: 4,
    archetype: "dogleg",
    dogleg: { dir: "left", severity: 0.32 },
    biome: "links",
    corridor: COVER_CORRIDOR.open,
    cover: "open",
    hazards: { bunkers: bunkers("landing-zone", "greenside-right"), water: null },
    signature: false,
    note: "Par 4 north, one of five corridors running side by side up the eastern boundary, finishing beside the 4th green. Open and overlooked from both sides -- the most exposed driving hole on the course.",
  },
  {
    number: 8,
    parTarget: 5,
    archetype: "dogleg",
    dogleg: { dir: "right", severity: 0.56 },
    biome: "links",
    corridor: COVER_CORRIDOR.moderate,
    cover: "moderate",
    hazards: { bunkers: bunkers("carry", "greenside-left"), water: null },
    signature: false,
    note: "The long way back south, teed from the junction by the 4th green. Three shots for most, two for anyone who takes the carry bunker on.",
  },
  {
    number: 9,
    parTarget: 4,
    ...
    corridor: COVER_CORRIDOR.open,
    cover: "open",
    hazards: { bunkers: bunkers("landing-zone"), water: null },
    signature: false,
    note: "Par 4 west, returning to the clubhouse. Benign as golf; in cart combat a shooting gallery with no cover for 300 m.",
  },
  {
    number: 10,
    parTarget: 3,
    ...
    corridor: COVER_CORRIDOR.open,
    cover: "open",
    hazards: { bunkers: bunkers("greenside-left", "greenside-right"), water: null },
    signature: false,
    note: "The tenth tee sits beside the first. A short par 3 out to the north-west, and the gentlest hole on the back nine -- the difficulty starts at 11.",
  },
  {
    number: 11,
    parTarget: 4,
    archetype: "drivable",
    dogleg: { dir: "right", severity: 0.32 },
    biome: "links",
    corridor: COVER_CORRIDOR.moderate,
    cover: "moderate",
    hazards: { bunkers: bunkers("landing-zone", "greenside-left"), water: null },
    signature: false,
    note: "320 yards up the western boundary. Drivable, and the fairway bunkers exist to make that a decision rather than a formality.",
  },
  {
    number: 12,
    parTarget: 4,
    archetype: "dogleg",
    dogleg: { dir: "right", severity: 0.72 },
    biome: "marsh",
    corridor: COVER_CORRIDOR.dense,
    cover: "dense",
    hazards: { bunkers: NO_BUNKERS, water: { form: "lateral-right" } },
    signature: false,
    note: "Par 4 north-east around the top of the large pond, water down the right through the turn. Dense cover on the other side and nowhere to break contact.",
  },
  {
    number: 13,
    parTarget: 4,
    archetype: "cape",
    dogleg: { dir: "left", severity: 0.8 },
    biome: "marsh",
    corridor: COVER_CORRIDOR.open,
    cover: "open",
    hazards: { bunkers: bunkers("greenside-right"), water: { form: "inside-elbow" } },
    signature: true,
    note: "SIGNATURE. The cape hole. The pond sits inside the turn and the fairway bends around it -- carry as much as you dare, because every metre of it is a shorter approach.",
  },
  {
    number: 14,
    parTarget: 5,
    archetype: "dogleg",
    dogleg: { dir: "left", severity: 0.56 },
    biome: "marsh",
    corridor: COVER_CORRIDOR.moderate,
    cover: "moderate",
    hazards: { bunkers: bunkers("carry", "greenside-right"), water: null },
    signature: false,
    note: "Par 5 south, the longest on the back nine. Dry, which after 12 and 13 reads as relief.",
  },
  {
    number: 15,
    parTarget: 4,
    ...
    corridor: COVER_CORRIDOR.moderate,
    cover: "moderate",
    hazards: { bunkers: bunkers("greenside-left"), water: { form: "lateral-right" } },
    signature: false,
    note: "Par 4 north with the smaller pond down the right. The last of the marsh, and the last water in play until the finish.",
  },
  {
    number: 16,
    parTarget: 4,
    ...
    corridor: COVER_CORRIDOR.moderate,
    cover: "moderate",
    hazards: { bunkers: bunkers("greenside-right"), water: { form: "lateral-left" } },
    signature: false,
    note: "Par 4 north up the eastern shore of the large pond, water all down the left through a hard right bend. Parkland returns here, but the hole does not let up.",
  },
  {
    number: 17,
    parTarget: 3,
    ...
    hazards: { bunkers: bunkers("greenside-left", "greenside-right"), water: null },
    signature: false,
    note: "The shortest hole on the card at 147 yards, reached by cart path across a public road and sitting on its own ground. Tight and tree-lined, placed where a match is usually decided.",
  },
  {
    number: 18,
    parTarget: 5,
    archetype: "dogleg",
    dogleg: { dir: "right", severity: 0.48 },
    biome: "parkland",
    corridor: COVER_CORRIDOR.open,
    cover: "open",
    hazards: { bunkers: bunkers("carry", "greenside-left"), water: { form: "lateral-right" } },
    signature: true,
    note: "SIGNATURE. Reachable par 5 finishing past the clubhouse, the smaller pond down the right off the second shot. A hole that can be won, which is what a closing hole is for.",
  },
];
